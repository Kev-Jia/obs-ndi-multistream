...
Install [DistroAV and NDI Tools](https:/github.com/DistroAV/wiki/1.-Installation#manual-install-ndi) and [NDI SDK](https://ndi.video/for-developers/ndi-sdk-download).
